...
export const telegramBotConfig: TelegramBotConfig = {
  ...
  slicing: {
    ...
    autoPrompt:
      ...
      'Кожна зона має повністю охоплювати ВСІ рядки таблиці, що належать одній справі (включно з продовженнями назви на наступних рядках). Не зливай дві сусідні справи в одну зону. Ігноруй заголовок таблиці і колонтитули. Поверни тільки JSON, без markdown і коментарів.',
    renderScale: 2.0,
