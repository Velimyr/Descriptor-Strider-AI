...
export const telegramBotConfig: TelegramBotConfig = {
  ...
  texts: {
    ...
    puzzleLegend:
      'Позначення:\n' +
      '• <code>слово</code> — треба зібрати\n' +
      '• <u><code>слово</code></u> — зібране, очікує підтвердження\n' +
      '• <code>СЛОВО</code> — зібране й підтверджене\n' +
      '• звичайний текст — слова, що не беруть участі в грі',
    puzzleCongrats:
